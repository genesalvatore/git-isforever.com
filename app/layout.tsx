...
export const metadata: Metadata = {
  ...
  keywords: ['git is forever', 'distributed permanence', 'digital immortality', 'distributed ledger', 'forever storage', 'permanent data', 'immutable history'],
  ...
  return (
    <html lang="en">
      <head>
        ...
        <CathedralStructuredData siteName="Git is Forever" siteUrl="https://git-isforever.com" description="Forever is not a promise. It's mathematics. Distributed across thousands of machines. Impossible to erase. Forever in the distributed ledger." theme="eternity" />
      </head>
      <body>
        <MatomoAnalytics siteId="6" />
        {children}
      </body>
    </html>
  )
